...
class JsonLdItemSerializer extends JsonLdSerializer {
  ...
  statements () {
    ...
    stmts.hasItemVolumes = this.body.numItemVolumesParsed / this.body.numItems > process.env.BIB_HAS_VOLUMES_THRESHOLD
    stmts.hasItemDates = this.body.numItemDatesParsed / this.body.numItems > process.env.BIB_HAS_DATES_THRESHOLD
