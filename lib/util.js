...
export const ITEM_LOCATION_AGG_SCRIPT = buildLocationScript('null', "if (['ma', 'pa', 'sc', 'rc', 'bu'].contains(parentLoc)) { return parentLoc; } return null;")
export const ITEM_LOCATION_FILTER_SCRIPT = buildLocationScript('false', "return ['ma', 'pa', 'sc', 'rc', 'bu'].contains(parentLoc) && params.locations.contains(parentLoc);")
