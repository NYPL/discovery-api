...
exports.parseParam = function (val, spec) {
  ...
  switch (spec.type) {
    ...
    case 'hash':
      ...
      break
    case 'boolean':
      if (val === 'true' || val === 'false') val === 'true'
      break
  }
...
exports.gatherParams = function (req, acceptedParams) {
  ...
  acceptedParams = (typeof acceptedParams === 'undefined') ? ['page', 'per_page', 'value', 'q', 'filters', 'contributor', 'subject', 'title', 'isbn', 'issn', 'lccn', 'oclc', 'merge_checkin_cards'] : acceptedParams
