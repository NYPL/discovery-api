...
class Location {
  constructor ({ locationCode, recapCustomerCode, m2CustomerCode }) {
    this.nyplCoreLocation = nyplCore.sierraLocations()[locationCode]
  ...
  get deliveryLocationByHoldingLocation () {
    if (this.nyplCoreLocation?.sierraDeliveryLocations) {
