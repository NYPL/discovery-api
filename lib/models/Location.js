...
class Location {
  ...
  get deliveryLocation () {
    ...
    if (this.requestable !== false) {
      return this.deliveryLocationByHoldingLocation || this.deliveryLocationsByRecapCustomerCode || this.deliveryLocationsByM2CustomerCode
    }
  }
