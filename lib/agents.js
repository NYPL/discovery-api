...
var AgentResultsSerializer = require('../serializers/agent/es').AgentResultsSerializer
var AgentSerializer = require('../serializers/agent/es').AgentSerializer
...
module.exports = function (app) {
  ...
  var getAgentById = function (params, cb) {
    ...
    app.esClient.get({
      ...
      cb(AgentSerializer.serialize(resp._source, {root: true, expandContext: params.expandContext === 'true'}))
    }, function (err) {
  ...
  var searchAgentByName = function (text, fuzziness, max_expansions, page, cb) {
    ...
    app.esClient.search({
      ...
      */
      ...
      cb(AgentResultsSerializer.serialize(resp))
      // cb(resultsLd)
    }, function (err) {
      if (err) throw err
      // console.trace(err.message)
  ...
  var searchAgentsByFilters = function (params, cb) {
    ...
    }).then((resp) => cb(AgentResultsSerializer.serialize(resp)), function (err) {
      console.trace(err.message)
      cb(false)
    })
  }
  ...
  var aggregationsByFilters = function (params, cb) {
    ...
    app.esClient.search({
      ...
      cb(AggregationsSerializer.serialize(resp, serializationOpts))
    }, function (err) {
      console.trace(err.message)
      cb(false)
    })
