...
const m2CustomerCodes = require('@nypl/nypl-core-objects')('by-nypl-customer-code')
...
class DeliveryLocationsResolver {
  ...
  // Fetch Sierra delivery locations by recap or m2 customer code. Returns undefined if the m2 customer code is not requestable:
  static __deliveryLocationsByCustomerCode (customerCode) {
    ...
    if (m2CustomerCodes[customerCode] && m2CustomerCodes[customerCode].sierraDeliveryLocations) {
