...
class DeliveryLocationsResolver {
  ...
  static __deliveryLocationsByHoldingLocation (holdingLocation) {
    ...
    if (!sierraLocationsDataForLocationCode) return
    ...
    if (deliverableToResolution === 'by-recap-customer-code' ||
      deliverableToResolution === 'by-m2-customer-code') {
      return require('@nypl/nypl-core-objects')(deliverableToResolution)
    ...
    // If deliverableToResolution is undefined, default to sierra locations data
      ...
      return sierraLocationsDataForLocationCode
        .deliverableTo.map((deliveryLocationCode) => {
          return {
            code: 'loc' + deliveryLocationCode,
