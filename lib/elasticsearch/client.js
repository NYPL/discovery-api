...
/**
 * Given an ES request body, performs a count query
 * against the configured ES index
 */
clientWrapper.count = function (body, index = process.env.RESOURCES_INDEX) {
  logger.debug(`Performing ES count: ${JSON.stringify(body, null, 2)}`)
