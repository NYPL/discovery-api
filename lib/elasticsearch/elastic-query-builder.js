...
class ElasticQueryBuilder {
  ...
  */
  ...
  filterClausesForDateParams (filters) {
    ...
    if (filters.dateAfter) { range.gte = `${filters.dateAfter}` } else { range.gte = '1000' }
    if (filters.dateBefore) {
      range.lte = `${filters.dateBefore}-12-31T23:59:59`
    } else {
      range.lte = '9999-12-31T23:59:59'
    }
    ...
    console.log('date query: ', JSON.stringify(query, null, 2))
