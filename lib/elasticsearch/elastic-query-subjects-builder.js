  ...
  */
  requirePrefixMatch () {
    this.query.addMust({
      bool: {
        should: [
          prefixMatch('preferredTerm.starts_with', this.request.querySansQuotes(), 1, true),
          prefixMatch('variants.starts_with', this.request.querySansQuotes(), 1, true)
        ]
      }
    })
  }
  ...
  */
  requireTermMatch () {
    this.query.addMust({
      bool: {
        should: [
          termMatch('preferredTerm.starts_with', this.request.querySansQuotes(), 10, true),
          termMatch('variants.starts_with', this.request.querySansQuotes(), 1, true)
        ]
      }
    })
  }
