...
const FILTER_CONFIG = {
  ...
  donor: { operator: 'match', field: ['donor.folded'], repeatable: true },
  titleAlt: { operator: 'match', field: ['titleAlt.folded', 'parallelTitleAlt.folded'], repeatable: true },
  uniformTitle: { operator: 'match', field: ['uniformTitle.folded', 'parallelUniformTitle.folded'], repeatable: true },
  addedAuthorTitle: { operator: 'match', field: ['addedAuthorTitle.folded'], repeatable: true },
  series: { operator: 'match', field: ['series', 'seriesParallel'], repeatable: true },
  placeOfPublication: { operator: 'match', field: ['placeOfPublication.folded'], repeatable: true },
  dateFrom: {
    operator: 'custom',
    type: 'string'
  },
