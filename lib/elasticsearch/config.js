...
const FILTER_CONFIG = {
  ...
  series: { operator: 'match', field: ['series', 'parallelSeries', 'seriesUniformTitle.keyword', 'parallelSeriesUniformTitle.keyword', 'seriesAddedEntry.keyword', 'parallelSeriesAddedEntry.keyword'], repeatable: true },
