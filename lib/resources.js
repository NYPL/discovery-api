...
module.exports = function (app, _private = null) {
  ...
  const addInnerHits = (body) => {
    if (body.query && body.query.function_score && body.query.function_score.query && body.query.function_score.query.bool && body.query.function_score.query.bool.should) {
      body.query.function_score.query.bool.should.push({
        nested: {
          ...
          inner_hits: {
            ...
            size: process.env.SEARCH_ITEMS_SIZE
          }
        }
      })
    }
