...
var parseSearchParams = function (params) {
  return util.parseParams(params, {
    ...
    lccn: { type: 'string' },
    oclc: { type: 'string' },
    merge_checkin_cards: { type: 'bool', default: false }
  })
}
...
module.exports = function (app, _private = null) {
  ...
  app.resources.findByUri = function (params, opts, request) {
    ...
    body = params.itemUri ? addItemQuery(body, params.itemUri) : addInnerHits(body, { size: params.items_size, from: params.items_from, merge_checkin_cards: params.merge_checkin_cards })
  ...
  const addInnerHits = (body, _options = {}) => {
    ...
    const query = options.merge_checkin_cards ? { match_all: {} } : {
      'bool': {
        'must_not': {
          'term': {
  ...
  app.resources.search = function (params, opts, request) {
    ...
    if (shouldAddInnerHits) {
      body = addInnerHits(body, { merge_checkin_cards: params['merge_checkin_cards'] })
    }
