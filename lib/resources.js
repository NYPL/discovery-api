...
module.exports = function (app) {
  ...
  app.resources.findByUri = function (params, opts) {
    ...
    return app.esClient.search({
      ...
      body: body
    }).then((resp) => ResourceSerializer.serialize(resp.hits.hits[0]._source, Object.assign({ root: true }, opts)))
  }
  ...
  app.resources.search = function (params, opts) {
    ...
    return app.esClient.search({
      index: RESOURCES_INDEX,
      body: body
    }).then((resp) => ResourceResultsSerializer.serialize(resp, opts))
  }
  ...
  app.resources.aggregations = function (params, opts) {
    ...
    log.info('Resources#aggregations:', JSON.stringify(body, null, 2))
    return app.esClient.search({
      index: RESOURCES_INDEX,
      body: body
  ...
  app.resources.aggregation = (params, opts) => {
    ...
    log.info('Resources#aggregation:', JSON.stringify(body, null, 2))
    return app.esClient.search({
      index: RESOURCES_INDEX,
      body: body
    }).then((resp) => {
