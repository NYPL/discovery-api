...
module.exports = function(app){
	...
	app.resources.searchByTitle = function(text, cb){
		console.log("app.resources.searchByTitle", text);
		searchResourcesByTitle(text,0,1, function(results) {
			console.log("  got results: ", results, cb)
			cb(results)
		})
	}

	app.resources.search = function(filters, cb){
		console.log("app.resources.search", filters);
		searchResourcesByTitle(text,0,1, function(results) {
			console.log("  got results: ", results, cb)
			cb(results)
		})
