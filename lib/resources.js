...
module.exports = function (app, _private = null) {
  ...
  const itemsQueryContext = (options) => {
    if (options.merge_checkin_card_items && options.removeElectronicResourcesFromItemsArray) {
    ...
    return { must_not: [{ term: { 'items.type': 'nypl:CheckinCardItem' } }, { exists: { field: 'items.electronicLocator' } }] }
  }
