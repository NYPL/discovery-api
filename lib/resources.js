...
const SEARCH_SCOPES = {
  all: {
    ...
    [
      ...
      'parallalSeriesStatement.folded',
  ...
  contributor: {
    fields: ['creatorLiteral^4', 'creatorLiteral.folded^2', 'contributorLiteral.folded', 'parallelCreatorLiteral', 'parallelContributorLiteral']
  },
  subject: {
    fields: ['subjectLiteral^2', 'subjectLiteral.folded', 'parallelSubjectLiteral']
  },
  series: {
