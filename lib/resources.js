...
module.exports = function (app, _private = null) {
    ...
    return scsbStatusLookup
      .then((recapBarcodesByStatus) => {
        ...
        return app.esClient.search(body)
          .then((resp) => {
            // ES 6.8 differs from ES 5.3 by nesting the old response in resp.body:
            resp = resp.body || {}
  ...
  app.resources.deliveryLocationsByBarcode = function (params, opts) {
    ...
    let lookupPatronType = AvailableDeliveryLocationTypes.getScholarRoomByPatronId(params.patronId)
      .catch((e) => {
