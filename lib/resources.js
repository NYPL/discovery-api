...
const RESOURCES_INDEX = 'discovery-resources2'
...
module.exports = function (app) {
  ...
  app.resources.search = function (params) {
    ...
    log.debug('Resources#search', JSON.stringify(body, null, 2))
    return app.esClient.search({
      index: RESOURCES_INDEX,
      body: body
  ...
  app.resources.aggregations = function (params) {
    ...
    var serializationOpts = {
      packed_fields: ['subject', 'contributor', 'collection', 'location', 'materialType', 'locationBuilding', 'language']
    }
